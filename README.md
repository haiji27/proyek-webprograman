# proyek-webprograman
html lang="id" baris ini digunakan untuk menandakan bahwa bahasa yang digunakan pada halaman adalah Bahasa Indonesia.
...
title Profil Diri /title ini berfungsi menentukan judul halaman yang muncul pada tab browser. /head ini berfungsi sebagai penutup head yang menandakan akhir dari bagian pengaturan halaman web sebelum masuk ke bagian konten utama (body). 
Serta style ini digunakan untuk menambahkan CSS jika ingin mempercantik tampilan website.
...
p Halaman profil pribadi menggunakan HTML /p, jadi p sebagai paragraf penjelasan singkat, sedangkan /p berfungsi untuk menutup paragraf teks yang dibuat dengan p sehingga struktur teks pada halaman web menjadi rapi dan mudah dibaca.
...
Code h2 id="tentang" Tentang Saya /h2 ini sebagai judul bagian dan target navigasi, id="tentang" digunakan agar menu navigasi dapat menuju bagian ini. 
...
th dan /th untuk membuat header tabel (tebal & rata tengah)
td digunakan untuk membuat isi tabel
ul digunakan untuk daftar tidak berurutan (keahlian).
li dan /li  berfungsi sebagai item list
ol dan /ol sebagai ordered list dan digunakan untuk daftar berurutan (hobi).
...
Nama - Email - Password - Pesan
Form ini bersifat statis dan digunakan sebagai tampilan antarmuka (belum terhubung ke backend).
video width="320" height="240" controls code ini berfungsi untuk menampilkan video di halaman web. Dimana video digunakan untuk menampilkan video profil yang dapat diputar langsung di halaman web, source sebagai file video lalu width="320" menunjukkan lebar video (320 pixel) dan height="240" menunjukkan tinggi video (240 pixel), lalu controls untuk menampilkan tombol play, pause, volume, fullscreen. serta /video menandakan akhir dari elemen video.
source src="haijivdo.mp4" type="video/mp4" yang berfungsi untuk menentukan file video yang diputar dan src="haijivdo.mp4" agar nama file video harus sesuai, serta type="video/mp4" menunjukkan format video
p© 2026 Nama Mahasiswa/p, dimana p digunakan untuk menampilkan teks paragraf, dimana bagian ini digunakan untuk menampilkan hak cipta (copyright) sebagai identitas pemilik website, dan /p berfungsi untuk menutup paragraf teks yang dibuat dengan p.
selanjutnya a href="https://github.com/haiji27/proyek-webprograman" GitHub /a | dan a href="https://www.instagram.com/withjiji_?igsh=bXo5b3U5bjB6Mzhn&utm_source=qr" Instagram /a Bagian ini berfungsi untuk menautkan website ke akun GitHub dan Instagram, dimana p digunakan untuk membuat paragraf, a digunakan untuk membuat link, lalu href berisi alamat tujuan link, serta tanda | sebagai pemisah antar link
a href="mailto:thaijijanuarli@gmail.com" Email /a | Bagian ini untuk menampilkan kontak email, dimana mailto: memungkinkan pengguna langsung membuka aplikasi email. Code ini digunakan agar pengunjung dapat menghubungi pemilik website melalui email
